...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_addpersonnel->Margin = System::Windows::Forms::Padding(2);
			...
			this->btn_supppersonnel->Margin = System::Windows::Forms::Padding(2);
			...
			this->btn_editpersonnel->Margin = System::Windows::Forms::Padding(2);
			...
			this->btn_editpersonnel->Click += gcnew System::EventHandler(this, &Personnel::btn_editpersonnel_Click);
			// 
			// btn_listpersonnel
			// 
			...
			this->btn_listpersonnel->Margin = System::Windows::Forms::Padding(2);
...
private: System::Void btn_editpersonnel_Click(System::Object^ sender, System::EventArgs^ e) {
	//MODIFIER PERSONNEL
	Interface::ModifierPersonnel^ modifierpersonnelFrm = gcnew Interface::ModifierPersonnel();
	modifierpersonnelFrm->ShowDialog();
}
};
}
