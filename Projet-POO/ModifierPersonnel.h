...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonmodifier->Click += gcnew System::EventHandler(this, &ModifierPersonnel::buttonmodifier_Click);
			// 
			...
			this->labelsupperieur->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(154)), static_cast<System::Int32>(static_cast<System::Byte>(140)),
				static_cast<System::Int32>(static_cast<System::Byte>(152)));
			this->labelsupperieur->Location = System::Drawing::Point(432, 87);
			this->labelsupperieur->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->labelsupperieur->Name = L"labelsupperieur";
			this->labelsupperieur->Size = System::Drawing::Size(118, 25);
			this->labelsupperieur->TabIndex = 54;
			this->labelsupperieur->Text = L"ID Personnel";
			// 
			// labeldateembauche
			// 
...
#pragma endregion
	...
	private: System::Void buttonmodifier_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ personnel_nom = textBox2->Text;
		String^ personnel_prenom = textBox5->Text;
		String^ personnel_date_embauche = textBox4->Text;
		String^ personnel_adresse_mail = textBox6->Text;
		String^ personnel_numero_telephone = textBox1->Text;
		int id_personnel = int::Parse(textBox3->Text);
		...
		{
			conDataBase->Open();
			SqlCommand^ cmdDataBase = gcnew SqlCommand("update Personnel set personnel_nom = '" + personnel_nom + "' WHERE id_personnel = '" + id_personnel + "'", conDataBase);
		...
		{
			conDataBase->Open();
			SqlCommand^ cmdDataBase = gcnew SqlCommand("update Personnel set personnel_prenom = '" + personnel_prenom + "' WHERE id_personnel = '" + id_personnel + "'", conDataBase);
			SqlDataReader^ myReader = cmdDataBase->ExecuteReader();
			dataGridView1->Rows->Clear();
			while (myReader->Read())
			{
		...
		{
			conDataBase->Open();
			SqlCommand^ cmdDataBase = gcnew SqlCommand("update Personnel set personnel_date_embauche = '" + personnel_date_embauche + "' WHERE id_personnel = '" + id_personnel + "'", conDataBase);
			SqlDataReader^ myReader = cmdDataBase->ExecuteReader();
			dataGridView1->Rows->Clear();
			while (myReader->Read())
			{
		...
		{
			conDataBase->Open();
			SqlCommand^ cmdDataBase = gcnew SqlCommand("update Personnel set personnel_adresse_mail = '" + personnel_adresse_mail + "' WHERE id_personnel = '" + id_personnel + "'", conDataBase);
			SqlDataReader^ myReader = cmdDataBase->ExecuteReader();
			dataGridView1->Rows->Clear();
			while (myReader->Read())
			{
		...
		{
			conDataBase->Open();
			SqlCommand^ cmdDataBase = gcnew SqlCommand("update Personnel set personnel_numero_telephone = '" + personnel_numero_telephone + "' WHERE id_personnel = '" + id_personnel + "'", conDataBase);
			SqlDataReader^ myReader = cmdDataBase->ExecuteReader();
			dataGridView1->Rows->Clear();
			while (myReader->Read())
			{
