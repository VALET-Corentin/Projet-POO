...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_chiffreaffaire->Location = System::Drawing::Point(76, 289);
			this->btn_chiffreaffaire->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->btn_chiffreaffaire->Click += gcnew System::EventHandler(this, &Comptabilite::btn_chiffreaffaire_Click);
			// 
			// button_topvente
			// 
			...
			this->button_topvente->Location = System::Drawing::Point(541, 46);
			this->button_topvente->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->button_moinvendu->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->btn_facture->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(154)), static_cast<System::Int32>(static_cast<System::Byte>(140)),
				static_cast<System::Int32>(static_cast<System::Byte>(152)));
			this->btn_facture->Location = System::Drawing::Point(541, 289);
			this->btn_facture->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			...
			this->ClientSize = System::Drawing::Size(933, 505);
...
#pragma endregion
	private: System::Void btn_chiffreaffaire_Click(System::Object^ sender, System::EventArgs^ e) {
		//CHIFFRE D'AFFAIRE
	}
