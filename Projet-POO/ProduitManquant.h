...
namespace Interface {
	...
	/// <summary>
	/// Description résumée de ProduitManquant
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonactualiser->Location = System::Drawing::Point(341, 54);
			...
			this->buttonactualiser->Click += gcnew System::EventHandler(this, &ProduitManquant::buttonactualiser_Click);
			// 
			// panelmove1
			// 
			...
			this->dataGridView1->Location = System::Drawing::Point(52, 149);
...
private: System::Void buttonactualiser_Click(System::Object^ sender, System::EventArgs^ e) {
	//AFFICHAGE PROUITS EN DESSOUS SEUIL REAPPRO

	String^ constring = "Data Source=LAPTOP-J0DFQRK5\\MSSQL;Initial Catalog=PROJET_POO2;Integrated Security=True";
	SqlConnection^ conDataBase = gcnew SqlConnection(constring);
	SqlCommand^ cmdDataBase = gcnew SqlCommand("select* from Article where(article_quantite < artcile_seuil_reapprovisionnement);", conDataBase);
	conDataBase->Open();
