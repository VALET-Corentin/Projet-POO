...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Comptabilité->Click += gcnew System::EventHandler(this, &MyForm::Personnel_Click);
			...
			this->X->Location = System::Drawing::Point(901, 6);
			this->X->Name = L"X";
			this->X->Size = System::Drawing::Size(25, 25);
			this->X->TabIndex = 1;
			this->X->Text = L"X";
...
#pragma endregion
	...
	private: System::Void Client_Click(System::Object^ sender, System::EventArgs^ e) {
		Interface::Client^ clientFrm = gcnew Interface::Client();
		clientFrm->Show();
		this->Hide();
	}
